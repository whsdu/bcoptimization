...
import qualified ASPIC.Defeasible    as D (Imp (..), Language, Literal (..),
                                           LiteralMap, LogicLanguage (..), Name,
                                           PreferenceMap, Rules (..), body,
                                           conC, getLogicLanguage, imp, name)

import           ASPIC.Abstraction   (AS (..), NegationFunction)
import qualified ASPIC.Default       as Default (isNegation, neg, ordering,
